...
.status-msg-body span{background-image: url(//4.bp.blogspot.com/-xQhgEZs7G70/W-JmR9gJGBI/AAAAAAAANck/1cc-Hmr6FdcCJnDzhX4XXeh-KO-SybExgCLcBGAs/s1600/line2.png);background-position:center bottom;background-repeat:no-repeat;margin-bottom:8px;color:#0091cf;text-transform:uppercase;padding:0 0 18px 0;text-align:center;font:700 18px 'oswald' ;}
/*=====================================
= B. Body
=====================================*/
...
.header,.topad{display:table-cell;vertical-align:middle;width:74%}
...
.intro .rcp-thumb:after{content:no-close-quote;position:absolute;bottom:0;width:100%;height:151px;background:url(//lh4.ggpht.com/-BJYQzaOHxBY/U2rZzP9ZInI/AAAAAAAAEFI/oliAqBKX2yE/s1600/gradient.png) repeat-x;opacity:.8}
...
.carousel .recent-thumb:before{content:no-close-quote;position:absolute;bottom:0;width:100%;height:150px;background:url(//lh4.ggpht.com/-BJYQzaOHxBY/U2rZzP9ZInI/AAAAAAAAEFI/oliAqBKX2yE/s1600/gradient.png) repeat-x;opacity:.8}
...
.post-body ul li {line-height: 1.4em; background: transparent url(//lh5.googleusercontent.com/-S35Tuev5YXk/VfFpYxomyjI/AAAAAAAAEm4/4ixLDnTSB5k/s1600/bullet1_16.png) no-repeat scroll 0px 4px;margin: 0.3em 0;padding: 0 0 0.8em 25px;}
.post-body ul li:hover {background: transparent url(//lh5.googleusercontent.com/-iyyaAeCCsFs/VfFpZAB1TwI/AAAAAAAAEm8/5ukP2SGOSZY/s1600/bullet2_16.png) no-repeat scroll 0px 4px;}
